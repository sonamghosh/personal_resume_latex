...
\fontsize{7pt}{8pt}\selectfont  % readjusted size
...
\begin{comment}
\begin{itemize}
   \item \textbf{Society of Asian Scientists \& Engineers} --- 
    \begin{itemize}
        \item h
    \end{itemize}
    Active alumni advisor, former Vice President, Secretary, and Junior Representative at BU. 
